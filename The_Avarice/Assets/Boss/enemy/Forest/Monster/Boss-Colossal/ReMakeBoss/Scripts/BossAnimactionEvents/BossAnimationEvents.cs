...
public class BossAnimationEvents : MonsterAniEvents
{
...
//====================================
    ...
    public void ColossalAttack(string trigger)=> dicAniEvents[trigger].Execute(BossController, attackCollisionData, BossStage);


    public void OnWarningWindow()=> ColossalEvent.Instance.UItrigger();
